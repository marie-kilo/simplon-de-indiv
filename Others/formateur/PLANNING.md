...
## Semaines (calendrier consolidé)

| Sem. | ☑️ | Dates | Phase | Contenu | Compétences |
|---|---|---|---|---|---|
| 0 | 🟢|18-22 mai  | 0 | EDA pandas | C8, C10 (n1) ; CT1, CT4 |
| 1 | 🟢|25-29 mai  | 0-1 | SQL : SQLite, PostgreSQL, psql, pgAdmin, psycopg2 | C8, C9, C11 (n1) |
| 2 | 🟢|1-5 juin  | 1 | Python : fichiers, HTTP/API, scraping, classes | C8, C9, C10 (n1-2) |
| 3 | 🟢|8-12 juin  | 1 | Git, MERISE, nettoyage, début RGPD | C4, C11 (n1) ; CT2, CT5 |
| 4 | 🟢|15-19 juin  | 1-2 | fin RGPD, insertions (COPY), lancement mégabase (brief 00, ~17/06) | C11 (n2), C9 (n2) |
| 5 | 🟢|22-26 juin  | 2 | mégabase : agile, collecte, intégration (briefs 01-03) | C8, C10 (n2), C15 (n1) ; CT1, CT2, CT9 |
| 6 | 🟡|29 juin-3 juil  | 2 | nouvelles sources, requêtes analytiques, Scalingo, entrepôt, début dbt (briefs 04-08) | C9, C10 (n2), C13 (n1-2), C14 (n1), C15 (n2), C16 (n1) |
| 7 | 🟠|6-10 juil   | 2 | corrections, dbt pour tous, SQL avancé (brief 09) | C15, C16 (n1-2), C9 (n2-3) |
| 8 | 🟠|13-17 juil   | 2 | laïcité (4 h), ITIL (4 h), veille, autonomie ; 14/07 férié | C4 (n2) ; CT6, CT7, CT8 |
| 9 | 🟠|20-24 juil   | 2 | historisation SCD2, dbt snapshots (brief 10) | **C17 (n1-3)** |
| 10 | 🟠|27-31 juil   | 2 | gérer et restituer : accès lecture, doc, soutenance mégabase | C16 (n2), C7 ; CT6, CT8 |
| | 🟠|3-14 août   | | **vacances** | |
| 11 | 🟠|17-21 août  | 3 | Docker : images, conteneurs, volumes, compose | C19 (n1) |
| 12 | 🟠|24-28 août  | 3 | MongoDB (NoSQL), stockage objet, Parquet | C18, C19 (n1) |
| 13 | 🟠|31 août-4 sept  | 3 | Spark (PySpark), orchestration (Airflow), catalogue, gouvernance | C18-C21 (n1) ; C4 |
| 14 | 🟠|7-11 sept  |  3 | Kafka et streaming en découverte, consolidation data lake, fermeture phase 3 | C19, C21 (n1) ; C5, C6 (n1) |
